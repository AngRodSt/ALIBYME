        ...
        <section className="absolute inset-0 flex items-center ">
          <div className="container mx-auto px-8 flex flex-col lg:flex-row gap-12 items-center lg:items-start ">
            ...
            <section className="flex-1 text-center lg:text-left space-y-6 ">
              ...
              <section className="flex gap-4 mt-15 justify-center lg:justify-start flex-wrap">
                {/* Desktop - Show all buttons */}
                <div className="hidden md:flex gap-4 flex-wrap">
                  <button
                    className={`flex items-center gap-2 font-semibold px-6 py-3 rounded-xl transition-all duration-200 hover:scale-105 ${
                      selectedStatus === "To Watch"
                        ? "bg-gradient-to-r from-[#DB372D] to-[#BD2D69] text-white hover:shadow-lg"
                        : "bg-white/10 backdrop-blur-sm text-white hover:bg-white/20"
                    }`}
                    onClick={() => setSelectedStatus("To Watch")}
                  >
                    <Bookmark size={20} />
                    To Watch
                  </button>
