    ...
    <div className="absolute inset-0 bg-black/90 backdrop-blur-sm rounded-lg flex flex-col items-center justify-center z-40">
      <div className="text-center space-y-4 px-6">
        ...
        <button
          ...
          className="bg-gradient-to-r from-[#DB372D] to-[#BD2D69] text-white font-semibold px-8 py-3 rounded-2xl transition-all duration-200 hover:scale-105 hover:shadow-lg hover:bg-gradient-to-l mt-4"
        >
